...
<!--        Assistant Warden-->
                ...
                <div class="col-lg-6 zero_pad">
                    ...
                    <div class="col-lg-7 col-md-8 f_right">
                        ...
                        <p>Assistant Professor<br>
                            ...
                            Tezpur University<br>
                            <i class="fa fa-mobile" aria-hidden="true"></i>+91-9954604524<br>
                            <i class="fa fa-envelope" aria-hidden="true"></i><a href="sushen@tezu.ernet.in"> sushen@tezu.ernet.in</a><br>
                            <i class="fa fa-globe" aria-hidden="true"></i> <a href="http://www.tezu.ernet.in/dmech/people/Updated_Fac_Profile/gen_format.php?INI=SK1">website</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div id="prefect" class="tab_content">
            <div class="row zero_mar zero_pad">
                <div class="col-lg-6 zero_pad">
                    <div class="col-lg-5 col-md-4 f_left">
                        <img src="media/admin/bitupan.jpg" class="img-thumbnail img-fluid" alt="Bitupan">
                    </div>
                    <div class="col-lg-7 col-md-8 f_right">
                        <h5>Mr. Bitopan Das</h5>
                        <p>Prefect<br>
                            Patkai Men's Hostel <br>
                            Department Of Commerce<br>
                            Tezpur University<br>
                            <i class="fa fa-mobile" aria-hidden="true"></i>+91-8638115413<br>
                    </div>
                </div>
                <!--                former prefects-->
                <div class="col-sm-12 zero_pad former_div">
...
<!--                one-->
                <div class="col-lg-6 zero_pad">
                    <div class="col-lg-5 col-md-4 f_left">
                        <img src="media/admin/pradipta.jpg" class="img-thumbnail img-fluid" alt="Pradipta">
                    </div>
                    <div class="col-lg-7 col-md-8 f_right">
                        <h5>Mr. Pradipta Kalita</h5>
                        <p>Assistant Prefect<br>
                            Patkai Men's Hostel<br>
                            Department Of Physics<br>
                            Tezpur University<br>
                            <i class="fa fa-mobile" aria-hidden="true"></i>+91-9132250829<br>
                    </div>
                </div>
<!--                two-->
                <div class="col-lg-6 zero_pad">
                    <div class="col-lg-5 col-md-4 f_left">
                        <img src="media/admin/bibek.jpg" class="img-thumbnail img-fluid" alt="Bibek">
                    </div>
                    <div class="col-lg-7 col-md-8 f_right">
                        <h5>Mr. Bibek Sarma</h5>
                        <p>Assistant Prefect<br>
                            Patkai Men's Hostel<br>
                            Dept. Of Electronics & Communication<br>
                            Tezpur University<br>
                            <i class="fa fa-mobile" aria-hidden="true"></i>+91-9101037231<br>
                    </div>
                </div>
<!--                three-->
                <div class="col-lg-6 zero_pad">
                    <div class="col-lg-5 col-md-4 f_left">
                        <img src="media/admin/ama.jpg" class="img-thumbnail img-fluid" alt="Amar">
                    </div>
                    <div class="col-lg-7 col-md-8 f_right">
                        <h5>Mr. Amar Jyoti Saikia</h5>
                        <p>Assistant Prefect<br>
                            Patkai Men's Hostel<br>
                            Department Of Commerce<br>
                            Tezpur University<br>
                            <i class="fa fa-mobile" aria-hidden="true"></i>+91-7399602658<br>
                    </div>
                </div>
<!--                four-->
                <div class="col-lg-6 zero_pad">
                    <div class="col-lg-5 col-md-4 f_left">
                        <img src="media/admin/pranav.jpg" class="img-thumbnail img-fluid" alt="Pranav">
                    </div>
                    <div class="col-lg-7 col-md-8 f_right">
                        <h5>Mr. Pranav Rawani</h5>
                        <p>Assistant Prefect<br>
                            Patkai Men's Hostel<br>
                            Department Of Civil Engineering<br>
                            Tezpur University<br>
                            <i class="fa fa-mobile" aria-hidden="true"></i>+91-9399423806<br>
                    </div>
                </div>
                ...
                <div class="col-sm-12 zero_pad former_div">
                    ...
                    <h6>Mr. Imdad Ahmed[2018-19]</h6>
                    <h6>Mr. Pranjal Choudhuri[2018-19]</h6>
                    <h6>Mr. Mridul Mohan Sarania[2018-19]</h6>
                </div>
            </div>
        </div>
        ...
        <div id="auditor" class="tab_content">
            <div class="row zero_mar zero_pad">
                <div class="col-lg-6 zero_pad">
                    <div class="col-lg-5 col-md-4 f_left">
                        <img src="media/admin/jitul.jpg" class="img-thumbnail img-fluid" alt="Jitul">
                    </div>
                    <div class="col-lg-7 col-md-8 f_right">
                        <h5>Mr. Jitul Rajbongshi</h5>
                        <p>Prefect<br>
                            Patkai Men's Hostel <br>
                            Dept. Of Computer Science and Engineering<br>
                            Tezpur University<br>
                            <i class="fa fa-mobile" aria-hidden="true"></i>+91-8011883175<br>
                    </div>
                </div>
                <!--                former prefects-->
                <div class="col-sm-12 zero_pad former_div">
                    <h5>Former Auditor</h5>
                    <h6>Mr. Bitupan Das [2018-2020 (present prefect)]</h6>
                </div>
            </div>
        </div>
...
<!--                one-->
                <div class="col-lg-6 zero_pad">
                    <div class="col-lg-5 col-md-4 f_left">
                        <img src="media/admin/angshuman.jpg" class="img-thumbnail img-fluid" alt="Angshuman">
                    </div>
                    <div class="col-lg-7 col-md-8 f_right">
                        <h5>Mr. Angshuman Aich</h5>
                        <p>Mess Convener<br>
                            Patkai Men's Hostel <br>
                            Department Of Chemistry<br>
                            Tezpur University<br>
                            <i class="fa fa-mobile" aria-hidden="true"></i>+91-8399025610<br>
                    </div>
                </div>
<!--                two-->
                <div class="col-lg-6 zero_pad">
                    <div class="col-lg-5 col-md-4 f_left">
                        <img src="media/admin/dhritishman.jpg" class="img-thumbnail img-fluid" alt="Dhritisman">
                    </div>
                    <div class="col-lg-7 col-md-8 f_right">
                        <h5>Mr. Dhritishman Das</h5>
                        <p>Sports and Cultural Convenor<br>
                            Patkai Men's Hostel<br>
                            Department Of Food Engineering Technology<br>
                            Tezpur University<br>
                            <i class="fa fa-mobile" aria-hidden="true"></i>+91-8133089140<br>
                    </div>
                </div>
                <!--                former convener-->
                <div class="col-sm-12 zero_pad former_div">
                    <h5>Former Conveners</h5>
                    <h6>Mr. Prince Prasad [2018-19(Mess Convenor)]</h6>
                    <h6>Mr. Gayakawada Ramanjaneyulu [2018-19(Assistant Mess Convenor)]</h6>
                    <h6>Mr. Amarjyoti Deka [2018-19(Sports and Cultural Convenor)]</h6>
                </div>
            </div>
        </div>
        ...
        <div id="o_staff" class="tab_content">
            <div class="row zero_mar zero_pad">
                <div class="col-lg-6 zero_pad">
                    <div class="col-lg-5 col-md-4 f_left">
                        <img src="media/admin/najimul.jpeg" class="img-thumbnail img-fluid" alt="Najimul">
                    </div>
                    <div class="col-lg-7 col-md-8 f_right">
                        <h5>Mr. Najimul Ahmed</h5>
                        <p>Caretaker<br>
                            Patkai Men's Hostel<br>
                            Tezpur University<br>
                            <i class="fa fa-mobile" aria-hidden="true"></i>+91-7896716501<br>
                    </div>
                </div>
        ...
        <div id="tech_team" class="tab_content">
            <div class="row zero_mar zero_pad">
                ...
                <div class="col-lg-6 zero_pad">
                    <div class="col-lg-5 col-md-4 f_left">
                        <img src="media/admin/madhu.jpg" class="img-thumbnail img-fluid" alt="Madhurjya">
                    </div>
                    <div class="col-lg-7 col-md-8 f_right">
                        <h5>Mr. Madhurjya Das</h5>
                        <p>Analyst<br>
                            Patkai Men's Hostel <br>
                            Department Of CSE<br>
                            Tezpur University<br>
                            <i class="fa fa-mobile" aria-hidden="true"></i>+91-8876840790<br>
                    </div>
                </div>
                <!--                two-->
                <div class="col-lg-6 zero_pad">
